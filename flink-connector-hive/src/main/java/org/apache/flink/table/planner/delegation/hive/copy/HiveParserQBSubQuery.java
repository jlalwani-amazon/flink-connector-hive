...
public class HiveParserQBSubQuery {
    ...
    static class ConjunctAnalyzer {
         ...
         */
        private MutablePair<HiveParserQBSubQuery.ExprType, ColumnInfo> analyzeExpr(
            ...
            if (expr.getType() == HiveASTParser.DOT) {
                ...
                return MutablePair.of(HiveParserQBSubQuery.ExprType.REFERS_SUBQUERY, null);
                ...
                return MutablePair.of(exprType, null);
            }
        }
        ...
        HiveParserQBSubQuery.Conjunct analyzeConjunct(HiveParserASTNode conjunct)
            ...
            if (type == HiveASTParser.EQUAL) {
                ...
                MutablePair<HiveParserQBSubQuery.ExprType, ColumnInfo> leftInfo = analyzeExpr(left);
                MutablePair<HiveParserQBSubQuery.ExprType, ColumnInfo> rightInfo =
                        analyzeExpr(right);
                ...
                MutablePair<HiveParserQBSubQuery.ExprType, ColumnInfo> sqExprInfo =
